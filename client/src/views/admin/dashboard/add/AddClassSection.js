...
// class section teacher  subject
    ...
    // const classSection = () => {
    //     Axios.post("http://192.168.1.38:3005/addClsSecTeach", {

    //     classId : classname ,
    //     sectionId : section ,
    //     classTeacherId : teacherName ,
    ...
    const classSection = () => {
        // Find the selected class, section, and teacher objects based on their names
        ...
        // Ensure that all required data is available before making the API call
                    ...
                    <CCol md={4}>
                        ...
                        <CForm>
                            ...
                            <CCol xs={12} className='text-center'>
                                <CButton className="px-4" type='submit' shape="rounded-pill" onClick={classSection}>
                                Add Class Section
                                </CButton>
                            </CCol>
                            </CRow><br/>
